...
Game::Game(b2World& box2dWorld, anax::World& anaxWorld, sf::RenderWindow& renderWindow) :m_b2world(&box2dWorld), m_anaxWorld(anaxWorld) , m_mainRenderWindow(&renderWindow),

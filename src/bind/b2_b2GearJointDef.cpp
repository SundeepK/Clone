...
static int b2GearJointDef__b2GearJointDef(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub::checksdata_d(L, 1, "b2.b2GearJointDef"));
    if (userdata->gc) {
...
static int b2GearJointDef__set_(lua_State *L) {
  ...
  b2GearJointDef *self = *((b2GearJointDef **)dub::checksdata_n(L, 1, "b2.b2GearJointDef"));
  const char *key = luaL_checkstring(L, 2);
  int key_h = dub::hash(key, 20);
  switch(key_h) {
    case 11: {
      if (DUB_ASSERT_KEY(key, "joint1")) break;
      dub::protect(L, 1, 3, "joint1");
      self->joint1 = *((b2Joint **)dub::checksdata_n(L, 3, "b2.b2Joint"));
      return 0;
    }
    case 12: {
      if (DUB_ASSERT_KEY(key, "joint2")) break;
      dub::protect(L, 1, 3, "joint2");
      self->joint2 = *((b2Joint **)dub::checksdata_n(L, 3, "b2.b2Joint"));
      return 0;
    }
    case 7: {
...
static int b2GearJointDef__get_(lua_State *L) {
  ...
  b2GearJointDef *self = *((b2GearJointDef **)dub::checksdata_n(L, 1, "b2.b2GearJointDef", true));
  const char *key = luaL_checkstring(L, 2);
  // <self> "key" <mt>
  // rawget(mt, key)
  lua_pushvalue(L, 2);
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2GearJoint.h:28
 */
static int b2GearJointDef_b2GearJointDef(lua_State *L) {
  try {
    b2GearJointDef *retval__ = new b2GearJointDef();
    dub::pushudata(L, retval__, "b2.b2GearJointDef", true);
    return 1;
  } catch (std::exception &e) {
...
static int b2GearJointDef___tostring(lua_State *L) {
  b2GearJointDef *self = *((b2GearJointDef **)dub::checksdata_n(L, 1, "b2.b2GearJointDef"));
  lua_pushfstring(L, "b2.b2GearJointDef: %p", self);
...
extern "C" int luaopen_b2_b2GearJointDef(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "b2.b2GearJointDef");
  // <mt>

  // register member methods
  dub::fregister(L, b2GearJointDef_member_methods);
  // setup meta-table
  dub::setup(L, "b2.b2GearJointDef");
  // <mt>
  return 1;
}

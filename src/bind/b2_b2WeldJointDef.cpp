...
static int b2WeldJointDef__b2WeldJointDef(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub::checksdata_d(L, 1, "b2.b2WeldJointDef"));
    if (userdata->gc) {
...
static int b2WeldJointDef__set_(lua_State *L) {
  ...
  b2WeldJointDef *self = *((b2WeldJointDef **)dub::checksdata_n(L, 1, "b2.b2WeldJointDef"));
...
static int b2WeldJointDef__get_(lua_State *L) {
  ...
  b2WeldJointDef *self = *((b2WeldJointDef **)dub::checksdata_n(L, 1, "b2.b2WeldJointDef", true));
  const char *key = luaL_checkstring(L, 2);
  // <self> "key" <mt>
  // rawget(mt, key)
  lua_pushvalue(L, 2);
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2WeldJoint.h:29
 */
static int b2WeldJointDef_b2WeldJointDef(lua_State *L) {
  try {
    b2WeldJointDef *retval__ = new b2WeldJointDef();
    dub::pushudata(L, retval__, "b2.b2WeldJointDef", true);
    return 1;
  } catch (std::exception &e) {
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2WeldJoint.h:41
 */
static int b2WeldJointDef_Initialize(lua_State *L) {
  try {
    b2WeldJointDef *self = *((b2WeldJointDef **)dub::checksdata(L, 1, "b2.b2WeldJointDef"));
...
static int b2WeldJointDef___tostring(lua_State *L) {
  b2WeldJointDef *self = *((b2WeldJointDef **)dub::checksdata_n(L, 1, "b2.b2WeldJointDef"));
  lua_pushfstring(L, "b2.b2WeldJointDef: %p", self);
...
extern "C" int luaopen_b2_b2WeldJointDef(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "b2.b2WeldJointDef");
  // <mt>

  // register member methods
  dub::fregister(L, b2WeldJointDef_member_methods);
  // setup meta-table
  dub::setup(L, "b2.b2WeldJointDef");
  // <mt>
  return 1;
}

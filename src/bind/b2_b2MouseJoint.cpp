...
static int b2MouseJoint__b2MouseJoint(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub::checksdata_d(L, 1, "b2.b2MouseJoint"));
    if (userdata->gc) {
...
static int b2MouseJoint__cast_(lua_State *L) {
  ...
  b2MouseJoint *self = *((b2MouseJoint **)dub::checksdata_n(L, 1, "b2.b2MouseJoint"));
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:65
 */
static int b2MouseJoint_GetAnchorA(lua_State *L) {
  try {
    b2MouseJoint *self = *((b2MouseJoint **)dub::checksdata(L, 1, "b2.b2MouseJoint"));
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:68
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:71
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:74
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:77
 */
static int b2MouseJoint_SetTarget(lua_State *L) {
  try {
    b2MouseJoint *self = *((b2MouseJoint **)dub::checksdata(L, 1, "b2.b2MouseJoint"));
    b2Vec2 *target = *((b2Vec2 **)dub::checksdata(L, 2, "b2.b2Vec2"));
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:78
 */
static int b2MouseJoint_GetTarget(lua_State *L) {
  try {
    b2MouseJoint *self = *((b2MouseJoint **)dub::checksdata(L, 1, "b2.b2MouseJoint"));
    dub::pushudata(L, const_cast<b2Vec2*>(&self->GetTarget()), "b2.b2Vec2", false);
    return 1;
  } catch (std::exception &e) {
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:81
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:82
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:85
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:86
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:89
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:90
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:93
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Dynamics/Joints/b2MouseJoint.h:96
 */
...
static int b2MouseJoint___tostring(lua_State *L) {
  b2MouseJoint *self = *((b2MouseJoint **)dub::checksdata_n(L, 1, "b2.b2MouseJoint"));
  lua_pushfstring(L, "b2.b2MouseJoint: %p", self);
...
extern "C" int luaopen_b2_b2MouseJoint(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "b2.b2MouseJoint");
  // <mt>

  // register member methods
  dub::fregister(L, b2MouseJoint_member_methods);
  // setup meta-table
  dub::setup(L, "b2.b2MouseJoint");
  // <mt>
  return 1;
}

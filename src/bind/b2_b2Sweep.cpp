...
static int b2Sweep__set_(lua_State *L) {
  ...
  b2Sweep *self = *((b2Sweep **)dub::checksdata_n(L, 1, "b2.b2Sweep"));
  const char *key = luaL_checkstring(L, 2);
  int key_h = dub::hash(key, 8);
  switch(key_h) {
    case 0: {
      if (DUB_ASSERT_KEY(key, "localCenter")) break;
      self->localCenter = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 5: {
      if (DUB_ASSERT_KEY(key, "c0")) break;
      self->c0 = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 3: {
...
static int b2Sweep__get_(lua_State *L) {
  ...
  b2Sweep *self = *((b2Sweep **)dub::checksdata_n(L, 1, "b2.b2Sweep", true));
  const char *key = luaL_checkstring(L, 2);
  // <self> "key" <mt>
  // rawget(mt, key)
  lua_pushvalue(L, 2);
  ...
  switch(key_h) {
    case 0: {
      if (DUB_ASSERT_KEY(key, "localCenter")) break;
      dub::pushudata(L, &self->localCenter, "b2.b2Vec2", false);
      return 1;
    }
    case 5: {
      if (DUB_ASSERT_KEY(key, "c0")) break;
      dub::pushudata(L, &self->c0, "b2.b2Vec2", false);
      return 1;
    }
    case 3: {
      if (DUB_ASSERT_KEY(key, "c")) break;
...
static int b2Sweep_b2Sweep(lua_State *L) {
  try {
    ...
    dub::pushudata(L, retval__, "b2.b2Sweep", true);
    return 1;
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Common/b2Math.h:384
 */
static int b2Sweep_GetTransform(lua_State *L) {
  try {
    b2Sweep *self = *((b2Sweep **)dub::checksdata(L, 1, "b2.b2Sweep"));
    b2Transform *xfb = *((b2Transform **)dub::checksdata(L, 2, "b2.b2Transform"));
    float32 beta = dub::checknumber(L, 3);
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Common/b2Math.h:388
 */
static int b2Sweep_Advance(lua_State *L) {
  try {
    b2Sweep *self = *((b2Sweep **)dub::checksdata(L, 1, "b2.b2Sweep"));
    float32 alpha = dub::checknumber(L, 2);
    self->Advance(alpha);
    return 0;
  } catch (std::exception &e) {
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Common/b2Math.h:391
 */
...
static int b2Sweep___tostring(lua_State *L) {
  b2Sweep *self = *((b2Sweep **)dub::checksdata_n(L, 1, "b2.b2Sweep"));
  lua_pushfstring(L, "b2.b2Sweep: %p", self);
...
extern "C" int luaopen_b2_b2Sweep(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "b2.b2Sweep");
  // <mt>

  // register member methods
  dub::fregister(L, b2Sweep_member_methods);
  // setup meta-table
  dub::setup(L, "b2.b2Sweep");
  // <mt>
  return 1;
}

...
static int b2EdgeShape__b2EdgeShape(lua_State *L) {
  try {
    DubUserdata *userdata = ((DubUserdata*)dub::checksdata_d(L, 1, "b2.b2EdgeShape"));
    if (userdata->gc) {
...
static int b2EdgeShape__set_(lua_State *L) {
  ...
  b2EdgeShape *self = *((b2EdgeShape **)dub::checksdata_n(L, 1, "b2.b2EdgeShape"));
  const char *key = luaL_checkstring(L, 2);
  int key_h = dub::hash(key, 14);
  switch(key_h) {
    case 9: {
      if (DUB_ASSERT_KEY(key, "m_vertex1")) break;
      self->m_vertex1 = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 10: {
      if (DUB_ASSERT_KEY(key, "m_vertex2")) break;
      self->m_vertex2 = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 8: {
      if (DUB_ASSERT_KEY(key, "m_vertex0")) break;
      self->m_vertex0 = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 11: {
      if (DUB_ASSERT_KEY(key, "m_vertex3")) break;
      self->m_vertex3 = **((b2Vec2 **)dub::checksdata_n(L, 3, "b2.b2Vec2"));
      return 0;
    }
    case 12: {
...
static int b2EdgeShape__get_(lua_State *L) {
  ...
  b2EdgeShape *self = *((b2EdgeShape **)dub::checksdata_n(L, 1, "b2.b2EdgeShape", true));
  const char *key = luaL_checkstring(L, 2);
  // <self> "key" <mt>
  // rawget(mt, key)
  lua_pushvalue(L, 2);
  ...
  switch(key_h) {
    case 9: {
      if (DUB_ASSERT_KEY(key, "m_vertex1")) break;
      dub::pushudata(L, &self->m_vertex1, "b2.b2Vec2", false);
      return 1;
    }
    case 10: {
      if (DUB_ASSERT_KEY(key, "m_vertex2")) break;
      dub::pushudata(L, &self->m_vertex2, "b2.b2Vec2", false);
      return 1;
    }
    case 8: {
      if (DUB_ASSERT_KEY(key, "m_vertex0")) break;
      dub::pushudata(L, &self->m_vertex0, "b2.b2Vec2", false);
      return 1;
    }
    case 11: {
      if (DUB_ASSERT_KEY(key, "m_vertex3")) break;
      dub::pushudata(L, &self->m_vertex3, "b2.b2Vec2", false);
      return 1;
    }
    case 12: {
      if (DUB_ASSERT_KEY(key, "m_hasVertex0")) break;
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:30
 */
static int b2EdgeShape_b2EdgeShape(lua_State *L) {
  try {
    b2EdgeShape *retval__ = new b2EdgeShape();
    dub::pushudata(L, retval__, "b2.b2EdgeShape", true);
    return 1;
  } catch (std::exception &e) {
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:33
 */
static int b2EdgeShape_Set(lua_State *L) {
  try {
    b2EdgeShape *self = *((b2EdgeShape **)dub::checksdata(L, 1, "b2.b2EdgeShape"));
    b2Vec2 *v1 = *((b2Vec2 **)dub::checksdata(L, 2, "b2.b2Vec2"));
    b2Vec2 *v2 = *((b2Vec2 **)dub::checksdata(L, 3, "b2.b2Vec2"));
    self->Set(*v1, *v2);
    return 0;
  } catch (std::exception &e) {
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:36
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:39
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:42
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:45
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:49
 */
 ...
 * /media/sundeep/3 tb Vol/code/Clone-game-repo/Clone-game/vendor/Box2D/Box2D/Collision/Shapes/b2EdgeShape.h:52
 */
...
static int b2EdgeShape___tostring(lua_State *L) {
  b2EdgeShape *self = *((b2EdgeShape **)dub::checksdata_n(L, 1, "b2.b2EdgeShape"));
  lua_pushfstring(L, "b2.b2EdgeShape: %p", self);
...
extern "C" int luaopen_b2_b2EdgeShape(lua_State *L)
{
  // Create the metatable which will contain all the member methods
  luaL_newmetatable(L, "b2.b2EdgeShape");
  // <mt>

  // register member methods
  dub::fregister(L, b2EdgeShape_member_methods);
  // setup meta-table
  dub::setup(L, "b2.b2EdgeShape");
  // <mt>
  return 1;
}

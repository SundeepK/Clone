...
public:
	...
	Level1Impl(b2World& b2dworld, anax::World& anaxWorld) : m_box2dWorld(&b2dworld), m_anaxWorld(&anaxWorld){
...
Level1::Level1(b2World& b2dworld, anax::World& anaxWorld) : m_impl(new Level1Impl(b2dworld, anaxWorld)) {
}
